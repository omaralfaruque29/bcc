...
<body class="sidebar-dark">
      ...
      <div class="row row-offcanvas row-offcanvas-right">
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
          ...
          <ul class="nav">
            ...
            <li class="nav-item">
              <a class="nav-link" href="{{URL::to('/add-student-page')}}">
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="layoutsSubmenu">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item">
                    <a class="nav-link" href="{{URL::to('/tution-fee')}}">Tution fee</a>
                  </li>
                  <li class="nav-item">
            ...
            <li class="nav-item">
              <a class="nav-link" data-toggle="collapse" href="#advancedSubmenu" aria-expanded="false" aria-controls="advancedSubmenu">
                ...
                <span class="menu-title">Course teacher</span>
                <i class="mdi mdi-chevron-down menu-arrow"></i>
              </a>
  ...
  <!-- Plugin js for all student data table page-->
  ...
  <script>
        $(document).on("click", "#delete", function(e) {
          e.preventDefault();
            bootbox.alert("Are you want to delete", function() {
